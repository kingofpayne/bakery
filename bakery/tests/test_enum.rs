...
fn test_basic_enum() {
    ...
    test_compile_ser(rec, "x: C", Some(&hex!("02000000")), E::C);
}
...
fn test_enum_tuple() {
    ...
    test_compile_ser(rec, "x: B(true)", Some(&hex!("0100000001")), E::B(true));
    test_compile_ser(rec, "x: B(false)", Some(&hex!("0100000000")), E::B(false));
    test_compile_ser(
        rec,
        "x: C(1627069767, false)",
